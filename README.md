...
The app is able to classify 7 types of skin lesions
...
The python code to build and train the model is included in the Jupyter notebook. All the javascript, css and html files are also freely available here.
